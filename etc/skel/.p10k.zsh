# Generated by Powerlevel10k configuration wizard on 2024-02-02 at 14:06 CST.
...
# angled separators, blurred heads, blurred tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_GIT_FREEBSD_ICON='\uF30C' # 
  typeset -g POWERLEVEL9K_VCS_GIT_FREEDESKTOP_ICON='\uF360' # 
  typeset -g POWERLEVEL9K_VCS_GIT_GNOME_ICON='\uF361' # 
  typeset -g POWERLEVEL9K_VCS_GIT_KDE_ICON='\uF373' # 
  ...
  #################################[ os_icon: os identifier ]##################################
  # Customization: use kanagawa colorscheme
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#223249'
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#9CABCA'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#938AA9'
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#363646'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#54546D'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#2A2A37'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND="#1F1F28"
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND="#1F1F28"
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%b%-d日(%a)%H:%M:%S}'
